        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="stat-card stat-card-bg-3">
                    <div class="stat-card-val"><?= $ongkir ?></div>
                    <p class="stat-card-title">Total Ongkir</p>
                    <i class="fa fa-truck-fast stat-card-icon"></i>
                </div>
            </div>

            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="stat-card stat-card-bronze">
                    <div class="stat-card-val"><?= $total_pesanan ?></div>
            ...
            <div class="col-12">
                <div class="card-premium">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="produk.php" class="btn-premium-primary">
