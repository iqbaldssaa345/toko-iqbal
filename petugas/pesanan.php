...
<div class="sidebar">
    ...
    <a href="pesanan.php" class="active"><i class="fa fa-receipt"></i> <span>Pesanan</span></a>
...
<div class="main-content">
    ...
    <!-- TOPBAR -->
    <div class="topbar">
        <h5><i class="fa fa-receipt me-2 text-primary"></i> Data Pesanan</h5>
    ...
    <div class="table-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="section-title">
                <i class="fa fa-box text-warning"></i> Kelola Pesanan
            </h5>
            ...
            <table class="table table-borderless align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($d['alamat_id']) ?></td>
                        <td><?= htmlspecialchars($d['ongkir_id']) ?></td>
                        <td><?= htmlspecialchars($d['tanggal']) ?></td>
                        <td><span class="badge bg-light text-dark px-3 py-2 rounded-pill shadow-sm" style="font-size: 0.9rem;">Rp <?= number_format($d['total']) ?></span></td>
                        <td class="text-center">
                            ...
                            <button type="button" class="btn btn-danger btn-action shadow-sm" onclick="konfirmasiHapus('pesanan.php?hapus=<?= $d['id'] ?>')" title="Hapus">
                            ...
                            <div class="modal-content">
                                <form method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label class="form-label text-muted small fw-bold mb-1 mt-2">Alamat ID</label>
                                        <input type="number" name="alamat_id" class="form-control" value="<?= $d['alamat_id'] ?>" required>
                                        
                                        <label class="form-label text-muted small fw-bold mb-1 mt-2">Ongkir ID</label>
                                        <input type="number" name="ongkir_id" class="form-control" value="<?= $d['ongkir_id'] ?>" required>
                                        
                                        <label class="form-label text-muted small fw-bold mb-1 mt-2">Total Harga</label>
        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <label class="form-label text-muted small fw-bold mb-1 mt-2">Alamat ID</label>
                    <input type="number" name="alamat_id" class="form-control" placeholder="Masukkan ID Alamat" required>
                    
                    <label class="form-label text-muted small fw-bold mb-1 mt-2">Ongkir ID</label>
                    <input type="number" name="ongkir_id" class="form-control" placeholder="Masukkan ID Ongkir" required>
                    
                    <label class="form-label text-muted small fw-bold mb-1 mt-2">Total Harga</label>
                    <input type="number" name="total" class="form-control" placeholder="Masukkan Total Harga" required>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light rounded-pill px-4" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" name="tambah" class="btn btn-primary rounded-pill px-4">Simpan Pesanan</button>
                </div>
            </form>
        </div>
    </div>
