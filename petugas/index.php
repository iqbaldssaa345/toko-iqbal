...
:root {
    ...
    --card-pesanan: linear-gradient(45deg,#00b09b,#96c93d);
...
.bg-pesanan { background: var(--card-pesanan); }
        ...
        <div class="col-12">
            <div class="table-wrapper">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="pesanan.php" class="btn-info-custom">
                    ...
                    <table class="table table-borderless align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <span class="price-badge">Rp <?= number_format($d['total'], 0, ',', '.') ?></span>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
