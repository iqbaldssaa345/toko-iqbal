...
if(isset($_POST['tambah'])){
    ...
    echo "<script>alert('Data berhasil ditambah');location='alamat.php';</script>";
}
...
if(isset($_GET['hapus'])){
    ...
    echo "<script>alert('Data berhasil dihapus');location='alamat.php';</script>";
}
...
if(isset($_POST['edit'])){
    ...
    echo "<script>alert('Data berhasil diupdate');location='alamat.php';</script>";
}
